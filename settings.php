...
if (has_capability('report/cpd:superadminview', $systemcontext)) {
    $ADMIN->add('modsettings',
        new admin_externalpage(
            'cpdmetadata',
            get_string('cpdreportadmin', 'report_cpd'),
            "$CFG->wwwroot/report/cpd/metadata.php",
            'report/cpd:superadminview'
        )
    );
}
if (has_capability('report/cpd:adminview', $systemcontext)) {
    $ADMIN->add(
        ...
        new admin_externalpage(
            ...
            "$CFG->wwwroot/report/cpd/adminview.php",
            'report/cpd:adminview'
        )
    );
}
